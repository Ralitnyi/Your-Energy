...
<li class="exercise-card">
  ...
  `).join("");v.innerHTML=t,document.querySelectorAll(".favorite-btn--trash").forEach(r=>{r.addEventListener("click",Ee)})}async function Ee(e){const t=e.target.closest(".favorite-btn--trash");if(!t)return;const r=t.dataset.id;H(r),await G()}document.querySelector(".favorites-list")&&G();const y=window.location.pathname.split("/").pop()||"",$e=document.querySelectorAll(".header__nav-link, .mobile-menu__link");$e.forEach(e=>{const t=e.getAttribute("href"),r=t==="./index.html"||t==="index.html"||t==="/";r&&(y===""||y==="index.html")||!r&&y===t.replace("./","")?e.classList.add("is-active"):e.classList.remove("is-active")});
//# sourceMappingURL=main-C1f983Y5.js.map
