...
<li class="exercise-card">
  ...
  `).join("");v.innerHTML=t,document.querySelectorAll(".favorite-btn--trash").forEach(r=>{r.addEventListener("click",Ee)})}async function Ee(e){const t=e.target.closest(".favorite-btn--trash");if(!t)return;const r=t.dataset.id;H(r),await W()}document.querySelector(".favorites-list")&&W();const p=window.location.pathname,$e=document.querySelectorAll(".header__nav-link, .mobile-menu__link");$e.forEach(e=>{const t=e.getAttribute("href"),r=t==="./index.html"||t==="index.html"||t==="/",o=p==="/"||p.endsWith("index.html")||p==="";r&&o||!r&&p.endsWith(t.replace("./",""))?e.classList.add("is-active"):e.classList.remove("is-active")});
//# sourceMappingURL=main-9F5wNQQn.js.map
